describe('Movie Search Tests', () => {
  ...
  describe('when conducting a search', () => {
    ...
    xit ('shows results in descending order by year when year header first clicked', (client) => {
    ...
    it ('shows results in ascending order by title when title he.waitForElementVisible(\'table tr:first-child td.movie-Year\', 500)ader first clicked', (client) => {
    ...
    describe('and selecting a movie', () => {
      ...
      //should only show \'Night of the Living Dead\' titled movies when I type that in
     xit('gg', (client) => {

        client
            .setValue('input.search-input', 'Night of the Living Dead')
            .waitForElementVisible('button.search-btn', 1000)
            .click('button.search-btn')
            .waitForElementVisible('table tr:first-child td.movie-Year', 500)
            .expect.element('td#movie-Title').to.contain.text('Night of the Living Dead');
